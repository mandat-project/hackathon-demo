<template>
  <div class="flex flex-column gap-2">
    ...
    <InputText :inputmode="type === 'number' ? 'numeric' : 'text'" class="pt-5 -mt-5" :id="id" :value="modelValue" :style =" { backgroundColor: backgroundColor }" :disabled="disabled" @keyup="update($event.target.value)" />
...
const props = defineProps<{ type: string; modelValue: string; label: string; disabled: boolean }>()
