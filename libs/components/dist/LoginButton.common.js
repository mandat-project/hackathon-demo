...
/* harmony export */ });
/* harmony import */ var hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(327);
...
__webpack_unused_export__ = ({ value: true });
__webpack_unused_export__ = void 0;
const solid_1 = __webpack_require__(327);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Session: function() { return /* reexport */ Session.Session; },
  ...
  __esModule: function() { return /* reexport */ namespaces.__esModule; },
  canonicaliseTerm: function() { return /* reexport */ canonicaliseTerm; },
  createContainer: function() { return /* reexport */ solidRequests.createContainer; },
  createResource: function() { return /* reexport */ solidRequests.createResource; },
  createResourceInAnyRegistrationOfShape: function() { return /* reexport */ interopRequest/* createResourceInAnyRegistrationOfShape */.R0; },
  deleteResource: function() { return /* reexport */ solidRequests.deleteResource; },
  getAclResourceUri: function() { return /* reexport */ solidRequests.getAclResourceUri; },
  getContainerItems: function() { return /* reexport */ solidRequests.getContainerItems; },
  getDataRegistrationContainers: function() { return /* reexport */ interopRequest/* getDataRegistrationContainers */.Iu; },
  getLinkHeader: function() { return /* reexport */ solidRequests.getLinkHeader; },
  getLocationHeader: function() { return /* reexport */ solidRequests.getLocationHeader; },
  getResource: function() { return /* reexport */ solidRequests.getResource; },
  parseToN3: function() { return /* reexport */ solidRequests.parseToN3; },
  patchResource: function() { return /* reexport */ solidRequests.patchResource; },
  postResource: function() { return /* reexport */ solidRequests.postResource; },
  putResource: function() { return /* reexport */ solidRequests.putResource; },
...
const _findLists = (n3Store) => {
    const listMapping = {};
    const endOfLists = n3Store.getQuads(null, (0,namespaces.RDF)("rest"), (0,namespaces.RDF)("nil"), null);
    endOfLists.forEach((quad) => {
        ...
        while (prevQuads.length !== 0) {
            ...
            itemQuads = n3Store.getQuads(currentQuad.subject, (0,namespaces.RDF)("first"), null, null);
            quads = itemQuads.concat(quads);
            items = itemQuads.map((quad) => quad.object).concat(items);
            prevQuads = n3Store.getQuads(null, (0,namespaces.RDF)("rest"), currentQuad.subject, null);
...
// EXTERNAL MODULE: ../solid/src/solidRequests.ts
var solidRequests = __webpack_require__(587);
// EXTERNAL MODULE: ../solid/src/interopRequest.ts
var interopRequest = __webpack_require__(314);
// EXTERNAL MODULE: ../solid/src/solid-oidc-client-browser/Session.ts + 5 modules
var Session = __webpack_require__(505);
...
__webpack_unused_export__ = ({ value: true });
exports.Iu = exports.R0 = void 0;
const namespaces_1 = __webpack_require__(760);
const Session_1 = __webpack_require__(505);
const solidRequests_1 = __webpack_require__(587);
...
exports.R0 = createResourceInAnyRegistrationOfShape;
...
exports.Iu = getDataRegistrationContainers;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  Session: function() { return /* binding */ Session; }
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getAclResourceUri = exports.getLinkHeader = exports.deleteResource = exports.patchResource = exports.putResource = exports.getContainerItems = exports.getLocationHeader = exports.createContainer = exports.createResource = exports.postResource = exports.getResource = exports.parseToN3 = void 0;
const axios_1 = __webpack_require__(148);
const n3_1 = __webpack_require__(61);
const namespaces_1 = __webpack_require__(760);
const Session_1 = __webpack_require__(505);
/**
