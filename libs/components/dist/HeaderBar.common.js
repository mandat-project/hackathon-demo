...
/* harmony export */ });
/* harmony import */ var hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(335);
...
const vue_1 = __webpack_require__(622);
const rdpCapableSession_1 = __webpack_require__(1);
let session;
...
exports.T = void 0;
const solid_1 = __webpack_require__(335);
...
__webpack_require__.d(__webpack_exports__, {
  ACL: function() { return /* reexport */ ACL; },
  AD: function() { return /* reexport */ AD; },
  AS: function() { return /* reexport */ AS; },
  AUTH: function() { return /* reexport */ AUTH; },
  CREDIT: function() { return /* reexport */ CREDIT; },
  DCT: function() { return /* reexport */ DCT; },
  ETHON: function() { return /* reexport */ ETHON; },
  FOAF: function() { return /* reexport */ FOAF; },
  GDPRP: function() { return /* reexport */ GDPRP; },
  INTEROP: function() { return /* reexport */ INTEROP; },
  LDCV: function() { return /* reexport */ LDCV; },
  LDP: function() { return /* reexport */ LDP; },
  MANDAT: function() { return /* reexport */ MANDAT; },
  ORG: function() { return /* reexport */ ORG; },
  PDGR: function() { return /* reexport */ PDGR; },
  PUSH: function() { return /* reexport */ PUSH; },
  RDF: function() { return /* reexport */ RDF; },
  RDFS: function() { return /* reexport */ RDFS; },
  SCHEMA: function() { return /* reexport */ SCHEMA; },
  SEC: function() { return /* reexport */ SEC; },
  SHAPETREE: function() { return /* reexport */ SHAPETREE; },
  SKOS: function() { return /* reexport */ SKOS; },
  SPACE: function() { return /* reexport */ SPACE; },
  SVCS: function() { return /* reexport */ SVCS; },
  Session: function() { return /* reexport */ Session; },
  VCARD: function() { return /* reexport */ VCARD; },
  WD: function() { return /* reexport */ WD; },
  WDT: function() { return /* reexport */ WDT; },
  WILD: function() { return /* reexport */ WILD; },
  XSD: function() { return /* reexport */ XSD; },
  canonicaliseTerm: function() { return /* reexport */ canonicaliseTerm; },
  ...
  toTTL: function() { return /* reexport */ toTTL; }
});

// EXTERNAL MODULE: external "n3"
var external_n3_ = __webpack_require__(61);
...
const _serialiseBlankNode = (bn, blankNodes, listMapping, n3Store, n3Writer) => {
    ...
    const bquads_serial = bquads.map((bquad) => {
        ...
        return new external_n3_.Quad(bquad.subject, bquad.predicate, obj, bquad.graph);
    });
    const battr = [];
...
const toTTL = (n3Store, n3Prefixes, baseIRI) => {
    n3Store = new external_n3_.Store(n3Store.getQuads(null, null, null, null));
    let result = "";
    const n3Writer = new external_n3_.Writer({
        baseIRI: baseIRI,
        prefixes: n3Prefixes,
    });
    // find lists
    ...
    Object.entries(listMapping).forEach(entry => {
        ...
        if (n3Store.countQuads(null, null, new external_n3_.BlankNode(entry[0]), null) !== 1) {
...
function getLocationHeader(resp) {
    if (!(resp.headers instanceof external_axios_namespaceObject.AxiosHeaders && resp.headers.has("Location"))) {
...
async function getLinkHeader(uri, session) {
    ...
    return session
        ...
        .then(_checkResponseStatus)
        .then((resp) => {
        if (!(resp.headers instanceof external_axios_namespaceObject.AxiosHeaders && resp.headers.has("Link"))) {
...
var update = add("4d4621a8", content, true, {"sourceMap":false,"shadowMode":false});
...
;// CONCATENATED MODULE: ../../node_modules/thread-loader/dist/cjs.js!../../node_modules/ts-loader/index.js??clonedRuleSet-40.use[1]!../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/HeaderBar.vue?vue&type=template&id=f467ac64&scoped=true&ts=true
...
const _hoisted_7 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,external_vue_.createElementVNode)("svg", {
...
const _hoisted_8 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,external_vue_.createElementVNode)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
    fill: "none",
...
const _hoisted_9 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,external_vue_.createElementVNode)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
    fill: "none",
...
const _hoisted_10 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/ (0,external_vue_.createElementVNode)("div", {
    style: { "height": "75px" },
            ...
            (0,external_vue_.createVNode)(_component_Toolbar, null, {
                start: (0,external_vue_.withCtx)(() => [
                        ...
                        (_ctx.isLoggedIn)
                            ? ((0,external_vue_.openBlock)(), (0,external_vue_.createBlock)(_component_Avatar, {
                                ...
                                default: (0,external_vue_.withCtx)(() => [
                                    ...
                                    (!_ctx.img && _ctx.isLoggedIn)
                                        ? ((0,external_vue_.openBlock)(), (0,external_vue_.createElementBlock)("i", _hoisted_4))
                                        : (0,external_vue_.createCommentVNode)("", true)
                                ]),
                                _: 1
                            }))
                    ...
                    (_ctx.webId)
                        ...
                        : (0,external_vue_.createCommentVNode)("", true),
                    (_ctx.webId)
                        ? ((0,external_vue_.openBlock)(), (0,external_vue_.createElementBlock)("div", _hoisted_6, "Demands"))
                        : (0,external_vue_.createCommentVNode)("", true)
                ]),
...
// EXTERNAL MODULE: ../composables/src/useServiceWorkerNotifications.ts
var useServiceWorkerNotifications = __webpack_require__(607);
...
// EXTERNAL MODULE: ../solid/index.ts + 11 modules
var solid = __webpack_require__(335);
// EXTERNAL MODULE: external "n3"
var external_n3_ = __webpack_require__(61);
// EXTERNAL MODULE: ../composables/src/useSolidSession.ts
var src_useSolidSession = __webpack_require__(865);
...
const useSolidProfile_useSolidProfile = () => {
    if (!session) {
        const { session: sessionRef } = (0,src_useSolidSession.useSolidSession)();
        session = sessionRef;
    }
    (0,external_vue_.watch)(() => session.webId, async () => {
        const webId = session.webId;
        let store = new external_n3_.Store();
        if (session.webId !== undefined) {
            store = await (0,solid.getResource)(webId)
                .then((resp) => resp.data)
                .then((respText) => (0,solid.parseToN3)(respText, webId))
                .then((parsedN3) => parsedN3.store);
        }
        let query = store.getObjects(webId, (0,solid.VCARD)("hasPhoto"), null);
        img.value = query.length > 0 ? query[0].value : "";
        query = store.getObjects(webId, (0,solid.VCARD)("fn"), null);
        useSolidProfile_name.value = query.length > 0 ? query[0].value : "";
        query = store.getObjects(webId, (0,solid.LDP)("inbox"), null);
        inbox.value = query.length > 0 ? query[0].value : "";
        query = store.getObjects(webId, (0,solid.SPACE)("storage"), null);
        storage.value = query.length > 0 ? query[0].value : "";
        query = store.getObjects(webId, (0,solid.INTEROP)("hasAuthorizationAgent"), null);
        authAgent.value = query.length > 0 ? query[0].value : "";
        query = store.getObjects(webId, (0,solid.INTEROP)("hasAccessInbox"), null);
        accessInbox.value = query.length > 0 ? query[0].value : "";
        query = store.getObjects(webId, (0,solid.ORG)("memberOf"), null);
        const uncheckedMemberOf = query.length > 0 ? query[0].value : "";
        if (uncheckedMemberOf !== "") {
            let storeOrg = new external_n3_.Store();
            storeOrg = await (0,solid.getResource)(uncheckedMemberOf)
                .then((resp) => resp.data)
                .then((respText) => (0,solid.parseToN3)(respText, uncheckedMemberOf))
                .then((parsedN3) => parsedN3.store);
            const isMember = storeOrg.getQuads(uncheckedMemberOf, (0,solid.ORG)("hasMember"), webId, null).length > 0;
            if (isMember) {
                memberOf.value = uncheckedMemberOf;
                query = storeOrg.getObjects(uncheckedMemberOf, (0,solid.MANDAT)("hasRightsDelegationProxy"), null);
                ...
                query = storeOrg.getObjects(memberOf.value, (0,solid.VCARD)("fn"), null);
                useSolidProfile_name.value += ` (Org: ${query.length > 0 ? query[0].value : "N/A"})`;
                query = storeOrg.getObjects(memberOf.value, (0,solid.LDP)("inbox"), null);
                inbox.value = query.length > 0 ? query[0].value : "";
                query = storeOrg.getObjects(memberOf.value, (0,solid.SPACE)("storage"), null);
                storage.value = query.length > 0 ? query[0].value : "";
                query = storeOrg.getObjects(memberOf.value, (0,solid.INTEROP)("hasAuthorizationAgent"), null);
                authAgent.value = query.length > 0 ? query[0].value : "";
                query = storeOrg.getObjects(memberOf.value, (0,solid.INTEROP)("hasAccessInbox"), null);
                accessInbox.value = query.length > 0 ? query[0].value : "";
            }
        }
    });
...
// EXTERNAL MODULE: ../composables/src/useSolidWebPush.ts
var useSolidWebPush = __webpack_require__(475);
// EXTERNAL MODULE: ../composables/src/webPushSubscription.ts
var webPushSubscription = __webpack_require__(568);
...
var rdpCapableSession = __webpack_require__(1);
...
/* harmony default export */ var HeaderBarvue_type_script_lang_ts = ((0,external_vue_.defineComponent)({
    ...
    setup() {
        const { hasActivePush, askForNotificationPermission } = (0,useServiceWorkerNotifications.useServiceWorkerNotifications)();
        const { subscribeForResource, unsubscribeFromResource } = (0,useSolidWebPush/* useSolidWebPush */.T)();
        const { session } = (0,src_useSolidSession.useSolidSession)();
...
var HeaderBarvue_type_style_index_0_id_f467ac64_scoped_true_lang_css = __webpack_require__(272);
...
/* harmony default export */ var entry_lib = (HeaderBar);
...
/******/ })()
;
//# sourceMappingURL=HeaderBar.common.js.map