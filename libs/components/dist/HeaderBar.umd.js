...
var rdpCapableSession_1 = __webpack_require__(0);
...
/* harmony export */ });
/* harmony import */ var _useSolidProfile__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(585);
/* harmony import */ var _useSolidSession__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(400);
...
/* harmony export */ });
/* harmony import */ var hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(574);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useSolidWebPush: function() { return /* binding */ useSolidWebPush; }
/* harmony export */ });
/* harmony import */ var hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(574);
/* harmony import */ var _useServiceWorkerNotifications__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(362);
/* harmony import */ var _useSolidSession__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(400);
...
const _getSolidWebPushDetails = async () => {
    const { store } = await (0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.getResource)(solidWebPushProfile)
        .then((resp) => resp.data)
        .then((txt) => (0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.parseToN3)(txt, solidWebPushProfile));
    const service = store.getSubjects((0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.AS)("Service"), null, null)[0];
    const inbox = store.getObjects(service, (0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.LDP)("inbox"), null)[0].value;
    const vapidPublicKey = store.getObjects(service, (0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.PUSH)("vapidPublicKey"), null)[0].value;
    return { inbox, vapidPublicKey };
};
const _createSubscriptionOnResource = (uri, details) => {
    return `
@prefix rdf: <${(0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.RDF)()}> .
@prefix as: <${(0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.AS)()}> .
@prefix push: <${(0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.PUSH)()}> .
<#sub> a as:Follow;
...
const subscribeForResource = async (uri) => {
    ...
    return (0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.createResource)(inbox, solidWebPushSub, session);
};
const unsubscribeFromResource = async (uri) => {
    ...
    return (0,hackathon_demo_libs_solid__WEBPACK_IMPORTED_MODULE_0__.createResource)(inbox, solidWebPushUnSub, session);
};
const useSolidWebPush = () => {
    if (!session) {
        session = (0,_useSolidSession__WEBPACK_IMPORTED_MODULE_2__.useSolidSession)().session;
    }
    if (!unsubscribeFromPush && !subscribeToPush) {
        const { unsubscribeFromPush: unsubscribeFromPushFunc, subscribeToPush: subscribeToPushFunc } = (0,_useServiceWorkerNotifications__WEBPACK_IMPORTED_MODULE_1__.useServiceWorkerNotifications)();
...
/* harmony export */ });
/* harmony import */ var n3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(907);
...
/* harmony import */ var _namespaces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(91);
...
var composables = __webpack_require__(395);
...
/* harmony default export */ var HeaderBarvue_type_script_lang_ts = ((0,external_vue_.defineComponent)({
    ...
    setup() {
        const { hasActivePush, askForNotificationPermission } = (0,composables.useServiceWorkerNotifications)();
        const { subscribeForResource, unsubscribeFromResource } = (0,composables.useSolidWebPush)();
        const { session } = (0,composables.useSolidSession)();
        const { name, img, inbox } = (0,composables.useSolidProfile)();
...
//# sourceMappingURL=HeaderBar.umd.js.map